...
(async () => {
  ...
  const pending = await fetch(base + '/api/question-bank', { method: 'POST', body: JSON.stringify({ exam:'LGS', lesson:'Matematik', topic:'Üslü İfadeler' }) });
  ...
  await page.locator('[data-jump="11"]').click();
  ...
  for(let i=0;i<30;i++){await page.locator('[data-jump="'+i+'"]').click();await page.locator('[data-answer="'+real.questions[i].correctIndex+'"]').click();}
